// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Constants.cs" company="Apprenda">
//   MIT License
// </copyright>
// <summary>
//   Constants Class
//   Used to provide common variables across multiple classes.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Apprenda.SaaSGrid.Addons.NetApp
{
    ...
    {
        /// <summary>
        /// The base script used to create a NetApp volume. If no custom script is provided, we use this.
        /// </summary>
        public const string CreateVolume = 
            ...
            {
	            throw ""Unable to connect to the VServer specified.  $env:ComputerName $_""
	            exit 2
            }
